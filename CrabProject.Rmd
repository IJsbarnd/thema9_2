...
### Data visualisation
To get a better view of how these attributes are correlated, multiple graphs were made. These graphs show the corralation between 2 attributes with the colored data points. These data points are colored to the color of the crab.
```{r plots, fig.cap= "Spread of Front lobe size against Carapace width based on color", echo=F, fig.height = 3.5, fig.width = 5}
...
```{r, fig.cap= "Spread of Rear width against Carapace length based on color", echo=F, fig.height = 3.5, fig.width = 5}
...
```{r, fig.cap="Spread of Body depth against Carapace width based on color", echo=F, fig.height = 3.5, fig.width = 5}
...
```{r gender, fig.cap="Spread of Carapace length against Rear width based on gender", echo=F, fig.height = 3.5, fig.width = 5}
...
```{r, fig.cap="Distribution of Carapace length for all male and female crabs", echo=F, fig.height = 3.5, fig.width = 5}
...
```{r, fig.cap="Distribution of Carapace length for the orange and the blue male and female crabs", echo=F, message=F}
require(gridExtra)
...
This plot shows a bigger difference in the length of the carapace between male and female blue crabs. Here, the difference is means does seem significant.
...
write.csv(clean_data, "cleanedData.csv", row.names = F, col.names = F)
```
